...
from app.utils.client_kinds import CLIENT_KIND_CHOICES
...
class ClientForm(FlaskForm):
    ...
    client_kind = SelectField("Вид клиента", choices=CLIENT_KIND_CHOICES, validators=[Optional()])
    ...
    reset_coords = BooleanField(
        "Сбросить координаты и пересчитать по адресу", validators=[Optional()]
    )
